...
public class InvoiceController {
	...
	public ArtistInvoiceResponse getDetailsInvoice(@RequestParam int id)
	{
		...
		return new ArtistInvoiceResponse(id, items, artistInvoice.getSubtotal(), artistInvoice.getTotal(), artistInvoice.getPayer(), artistInvoice.getPayee(), artistInvoice.getDate());
	}
